...
class UserProfile {
    ...
    class func fillUserData(_ id: Int, _ name: String, _ arName: String, _ email: String, _ city: Int, _ mobileNum: String, _ userType: Int, _ token: String = UserProfile.shared.userToken ?? "") {
