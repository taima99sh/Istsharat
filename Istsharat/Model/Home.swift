...
class AdvsModel : NSObject, NSCoding{
    ...
    init(fromJson json: JSON!){
        ...
        advs = [Adv]()
        let advsArray = json["Advs"].arrayValue
        for advsJson in advsArray{
            let value = Adv(fromJson: advsJson)
            advs.append(value)
        }
        success = json["Success"].boolValue
        code = json["code"].intValue
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if advs != nil{
            var dictionaryElements = [[String:Any]]()
            for advsElement in advs {
                dictionaryElements.append(advsElement.toDictionary())
            }
            dictionary["Advs"] = dictionaryElements
        }
        if success != nil{
            dictionary["Success"] = success
        }
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
    {
         advs = aDecoder.decodeObject(forKey: "Advs") as? [Adv]
         success = aDecoder.decodeObject(forKey: "Success") as? Bool
         code = aDecoder.decodeObject(forKey: "code") as? Int
         message = aDecoder.decodeObject(forKey: "message") as? String
    ...
    */
    ...
    {
        if advs != nil{
            aCoder.encode(advs, forKey: "Advs")
        }
        if success != nil{
            aCoder.encode(success, forKey: "Success")
        }
